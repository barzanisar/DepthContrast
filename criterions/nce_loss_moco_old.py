...
class NCELossMoco(nn.Module):
    ...
    def forward(self, output):
        ...
        if output[0]['vdc_voxel_bzyx'] is not None:
            coords_0 = output[0]['vdc_voxel_bzyx'] # vox_coords from query encoder = list of len total num voxels=1181, each element has a numpy array with a voxel coord = bzyx
            coords_1 = output[1]['vdc_voxel_bzyx'] # vox_coords from key encoder

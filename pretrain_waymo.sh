...
sbatch --time=03:00:00 --nodes=2 --ntasks=2 --array=1-20%1 --job-name=pretrain_centerpoint scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19667 --cfg_file configs/waymo_centerpoint.yaml
sbatch --time=03:00:00 --nodes=3 --ntasks=3 --array=1-10%1 --job-name=pretrain_3node_centerpoint scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19667 --cfg_file configs/waymo_centerpoint_3node.yaml

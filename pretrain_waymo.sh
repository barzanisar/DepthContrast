sbatch --time=05:00:00 --nodes=2 --ntasks=2 --array=1-10%1 --job-name=pretrain_waymo_pointrcnn scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19664 --cfg_file configs/waymo_pointrcnn.yaml
sbatch --time=05:00:00 --nodes=2 --ntasks=2 --array=1-10%1 --job-name=pretrain_waymo_centerpoint scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19667 --cfg_file configs/waymo_centerpoint.yaml

sbatch --time=00:30:00 --nodes=1 --ntasks=1 --array=1-1%1 --job-name=pretrain_waymo_pointrcnn scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19664 --cfg_file configs/waymo_pointrcnn.yaml
sbatch --time=00:30:00 --nodes=1 --ntasks=1 --array=1-1%1 --job-name=pretrain_waymo_centerpoint scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19667 --cfg_file configs/waymo_centerpoint.yaml

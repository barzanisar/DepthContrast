...
sbatch --time=3:00:00 --nodes=1 --ntasks=1 --array=1-6%1 --job-name=esf_perc_0p5 scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19215 --cfg_file configs/waymo_pointrcnn_backbone_esf_perc_0p5.yaml

sbatch --time=3:00:00 --nodes=1 --ntasks=1 --array=1-6%1 --job-name=iou_thresh_0p3 scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19216 --cfg_file configs/waymo_pointrcnn_backbone_iou_thresh_0p3.yaml
...
sbatch --time=5:00:00 --account=def-swasland-ab --gres=gpu:v100l:4 --mem=180G --nodes=1 --ntasks=1 --array=1-1%1 --job-name=fine1lr_e15_mink_segcontrast scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19641 --downstream --cfg_file configs/waymo_fine1lr_minkunet_segcontrast.yaml --pretrained_ckpt checkpoint-ep99.pth.tar
sbatch --time=5:00:00 --account=def-swasland-ab --gres=gpu:v100l:4 --mem=180G --nodes=1 --ntasks=1 --array=1-1%1 --job-name=fine1lr_e15_mink_iou_perc_0p3 scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19651 --downstream --cfg_file configs/waymo_fine1lr_minkunet_iou_perc_0p3.yaml --pretrained_ckpt checkpoint-ep99.pth.tar
# sbatch --time=5:00:00 --account=def-swasland-ab --gres=gpu:v100l:4 --mem=180G --nodes=1 --ntasks=1 --array=1-5%1 --job-name=fine1lr_e30_mink_segcontrast scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19641 --downstream --cfg_file configs/waymo_fine1lr_minkunet_segcontrast.yaml --pretrained_ckpt checkpoint-ep99.pth.tar --epochs 30
# sbatch --time=5:00:00 --account=def-swasland-ab --gres=gpu:v100l:4 --mem=180G --nodes=1 --ntasks=1 --array=1-5%1 --job-name=fine1lr_e30_mink_iou_perc_0p3 scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19651 --downstream --cfg_file configs/waymo_fine1lr_minkunet_iou_perc_0p3.yaml --pretrained_ckpt checkpoint-ep99.pth.tar --epochs 30
# sbatch --time=5:00:00 --account=def-swasland-ab --gres=gpu:v100l:4 --mem=180G --nodes=1 --ntasks=1 --array=1-5%1 --job-name=fine1lr_e60_mink_segcontrast scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19641 --downstream --cfg_file configs/waymo_fine1lr_minkunet_segcontrast.yaml --pretrained_ckpt checkpoint-ep99.pth.tar --epochs 60
# sbatch --time=5:00:00 --account=def-swasland-ab --gres=gpu:v100l:4 --mem=180G --nodes=1 --ntasks=1 --array=1-5%1 --job-name=fine1lr_e60_mink_iou_perc_0p3 scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19651 --downstream --cfg_file configs/waymo_fine1lr_minkunet_iou_perc_0p3.yaml --pretrained_ckpt checkpoint-ep99.pth.tar --epochs 60
# sbatch --time=5:00:00 --account=def-swasland-ab --gres=gpu:v100l:4 --mem=180G --nodes=1 --ntasks=1 --array=1-5%1 --job-name=fine1lr_e100_mink_segcontrast scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19641 --downstream --cfg_file configs/waymo_fine1lr_minkunet_segcontrast.yaml --pretrained_ckpt checkpoint-ep99.pth.tar --epochs 100
# sbatch --time=5:00:00 --account=def-swasland-ab --gres=gpu:v100l:4 --mem=180G --nodes=1 --ntasks=1 --array=1-5%1 --job-name=fine1lr_e100_mink_iou_perc_0p3 scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19651 --downstream --cfg_file configs/waymo_fine1lr_minkunet_iou_perc_0p3.yaml --pretrained_ckpt checkpoint-ep99.pth.tar --epochs 100

# #minkunet-pretrained on 5% waymo - finetune 2lrs on 1% waymo
sbatch --time=5:00:00 --account=def-swasland-ab --gres=gpu:v100l:4 --mem=180G --nodes=1 --ntasks=1 --array=1-1%1 --job-name=fine2lrs_e15_mink_segcontrast scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19661 --downstream --cfg_file configs/waymo_fine2lrs_minkunet_segcontrast.yaml --pretrained_ckpt checkpoint-ep99.pth.tar
sbatch --time=5:00:00 --account=def-swasland-ab --gres=gpu:v100l:4 --mem=180G --nodes=1 --ntasks=1 --array=1-1%1 --job-name=fine2lrs_e15_mink_iou_perc_0p3 scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19671 --downstream --cfg_file configs/waymo_fine2lrs_minkunet_iou_perc_0p3.yaml --pretrained_ckpt checkpoint-ep99.pth.tar
# sbatch --time=5:00:00 --account=def-swasland-ab --gres=gpu:v100l:4 --mem=180G --nodes=1 --ntasks=1 --array=1-5%1 --job-name=fine2lrs_e30_mink_segcontrast scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19661 --downstream --cfg_file configs/waymo_fine2lrs_minkunet_segcontrast.yaml --pretrained_ckpt checkpoint-ep99.pth.tar --epochs 30
# sbatch --time=5:00:00 --account=def-swasland-ab --gres=gpu:v100l:4 --mem=180G --nodes=1 --ntasks=1 --array=1-5%1 --job-name=fine2lrs_e30_mink_iou_perc_0p3 scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19671 --downstream --cfg_file configs/waymo_fine2lrs_minkunet_iou_perc_0p3.yaml --pretrained_ckpt checkpoint-ep99.pth.tar --epochs 30
# sbatch --time=5:00:00 --account=def-swasland-ab --gres=gpu:v100l:4 --mem=180G --nodes=1 --ntasks=1 --array=1-5%1 --job-name=fine2lrs_e60_mink_segcontrast scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19661 --downstream --cfg_file configs/waymo_fine2lrs_minkunet_segcontrast.yaml --pretrained_ckpt checkpoint-ep99.pth.tar --epochs 60
# sbatch --time=5:00:00 --account=def-swasland-ab --gres=gpu:v100l:4 --mem=180G --nodes=1 --ntasks=1 --array=1-5%1 --job-name=fine2lrs_e60_mink_iou_perc_0p3 scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19671 --downstream --cfg_file configs/waymo_fine2lrs_minkunet_iou_perc_0p3.yaml --pretrained_ckpt checkpoint-ep99.pth.tar --epochs 60
# sbatch --time=5:00:00 --account=def-swasland-ab --gres=gpu:v100l:4 --mem=180G --nodes=1 --ntasks=1 --array=1-5%1 --job-name=fine2lrs_e100_mink_segcontrast scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19661 --downstream --cfg_file configs/waymo_fine2lrs_minkunet_segcontrast.yaml --pretrained_ckpt checkpoint-ep99.pth.tar --epochs 100
# sbatch --time=5:00:00 --account=def-swasland-ab --gres=gpu:v100l:4 --mem=180G --nodes=1 --ntasks=1 --array=1-5%1 --job-name=fine2lrs_e100_mink_iou_perc_0p3 scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19671 --downstream --cfg_file configs/waymo_fine2lrs_minkunet_iou_perc_0p3.yaml --pretrained_ckpt checkpoint-ep99.pth.tar --epochs 100

sbatch --time=2:00:00 --account=def-swasland-ab --gres=gpu:v100l:4 --mem=180G --nodes=1 --ntasks=1 --array=1-1%1 --job-name=fine2lrs_ptrcnn_segcontrast scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19661 --downstream --cfg_file configs/waymo_fine2lrs_pointrcnn_segcontrast.yaml --pretrained_ckpt checkpoint-ep49.pth.tar
sbatch --time=2:00:00 --account=def-swasland-ab --gres=gpu:v100l:4 --mem=180G --nodes=1 --ntasks=1 --array=1-1%1 --job-name=fine2lrs_ptrcnn_iou_perc_0p3 scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19671 --downstream --cfg_file configs/waymo_fine2lrs_pointrcnn_iou_perc_0p3.yaml --pretrained_ckpt checkpoint-ep49.pth.tar
sbatch --time=2:00:00 --account=def-swasland-ab --gres=gpu:v100l:4 --mem=180G --nodes=1 --ntasks=1 --array=1-1%1 --job-name=fine2lrs_ptrcnn_esf_perc_0p3 scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19681 --downstream --cfg_file configs/waymo_fine2lrs_pointrcnn_esf_perc_0p3.yaml --pretrained_ckpt checkpoint-ep49.pth.tar

##################### Final ###############

#narval
sbatch --time=5:00:00 --nodes=1 --ntasks=1 --array=1-30%1 --job-name=ptrcnn_iou_perc_0p3_w10 scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19325 --cfg_file configs/waymo_pointrcnn_iou_perc_0p3_waymo10.yaml
sbatch --time=5:00:00 --nodes=1 --ntasks=1 --array=1-30%1 --job-name=ptrcnn_segcontrast_w10 scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19326 --cfg_file configs/waymo_pointrcnn_segcontrast_waymo10.yaml
sbatch --time=00:05:00 --nodes=1 --ntasks=1 --array=1-1%1 --job-name=ptrcnn_iou_perc_0p3_w10 scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19325 --cfg_file configs/waymo_pointrcnn_iou_perc_0p3_waymo10.yaml

#cedar
# Pointrcnn pretrain stage1
sbatch --time=5:00:00 --account=def-swasland-ab --gres=gpu:v100l:4 --mem=180G --nodes=2 --ntasks=2 --array=1-10%1 --job-name=ptrcnn_iou_perc_0p3_w10 scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19325 --cfg_file configs/waymo_pointrcnn_iou_perc_0p3_waymo10.yaml
sbatch --time=5:00:00 --account=def-swasland-ab --gres=gpu:v100l:4 --mem=180G --nodes=2 --ntasks=2 --array=1-10%1 --job-name=ptrcnn_segcontrast_w10 scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19326 --cfg_file configs/waymo_pointrcnn_segcontrast_waymo10.yaml
...
# sbatch --time=5:00:00 --account=def-swasland-ab --gres=gpu:v100l:4 --mem=180G --nodes=1 --ntasks=1 --array=1-1%1 --job-name=lpseg_ptrcnn_iou_perc_0p3_w10 scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19335 --downstream --cfg_file configs/waymo_lpseg_pointrcnn_iou_perc_0p3_waymo10.yaml --linear_probe_last_n_ckpts 10
# sbatch --time=5:00:00 --account=def-swasland-ab --gres=gpu:v100l:4 --mem=180G --nodes=1 --ntasks=1 --array=1-1%1 --job-name=lpseg_ptrcnn_segcontrast_w10 scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19336 --downstream --cfg_file configs/waymo_lpseg_pointrcnn_segcontrast_waymo10.yaml --linear_probe_last_n_ckpts 10

# # Pointrcnn linear probe stage2
# sbatch --time=5:00:00 --account=def-swasland-ab --gres=gpu:v100l:4 --mem=180G --nodes=1 --ntasks=1 --array=1-1%1 --job-name=lpseg_ptrcnn_iou_perc_0p3_w10_stage2 scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19345 --downstream --cfg_file configs/waymo_lpseg_pointrcnn_iou_perc_0p3_waymo10_stage2.yaml --linear_probe_last_n_ckpts 10
# sbatch --time=5:00:00 --account=def-swasland-ab --gres=gpu:v100l:4 --mem=180G --nodes=1 --ntasks=1 --array=1-1%1 --job-name=lpseg_ptrcnn_segcontrast_w10_stage2 scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19346 --downstream --cfg_file configs/waymo_lpseg_pointrcnn_segcontrast_waymo10_stage2.yaml --linear_probe_last_n_ckpts 10

#minkunet pretrain
sbatch --time=5:00:00 --dependency=afterany:21730715 --account=def-swasland-ab --gres=gpu:v100l:4 --mem=180G --nodes=2 --ntasks=2 --array=1-10%1 --job-name=mink_segcontrast_w10 scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19631 --cfg_file configs/waymo_minkunet_segcontrast_waymo10.yaml
sbatch --time=5:00:00 --dependency=afterany:21730719 --account=def-swasland-ab --gres=gpu:v100l:4 --mem=180G --nodes=2 --ntasks=2 --array=1-10%1 --job-name=mink_iou_perc_0p3_w10 scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19621 --cfg_file configs/waymo_minkunet_iou_perc_0p3_waymo10.yaml

# #minkunet linear probe
# sbatch --time=5:00:00 --account=def-swasland-ab --gres=gpu:v100l:4 --mem=180G --nodes=1 --ntasks=1 --array=1-1%1 --job-name=lpseg_mink_segcontrast_w10 scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19631 --downstream --cfg_file configs/waymo_lpseg_minkunet_segcontrast_waymo10.yaml --linear_probe_last_n_ckpts 10
# sbatch --time=5:00:00 --account=def-swasland-ab --gres=gpu:v100l:4 --mem=180G --nodes=1 --ntasks=1 --array=1-1%1 --job-name=lpseg_mink_iou_perc_0p3_w10 scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19621 --downstream --cfg_file configs/waymo_lpseg_minkunet_iou_perc_0p3_waymo10.yaml --linear_probe_last_n_ckpts 10

# #minkunet finetune one lr
# sbatch --time=5:00:00 --account=def-swasland-ab --gres=gpu:v100l:4 --mem=180G --nodes=1 --ntasks=1 --array=1-5%1 --job-name=fine1lr_e15_mink_segcontrast_w10 scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19641 --downstream --cfg_file configs/waymo_fine1lr_minkunet_segcontrast_waymo10.yaml --pretrained_ckpt checkpoint-ep99.pth.tar
# sbatch --time=5:00:00 --account=def-swasland-ab --gres=gpu:v100l:4 --mem=180G --nodes=1 --ntasks=1 --array=1-5%1 --job-name=fine1lr_e15_mink_iou_perc_0p3_w10 scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19651 --downstream --cfg_file configs/waymo_fine1lr_minkunet_iou_perc_0p3_waymo10.yaml --pretrained_ckpt checkpoint-ep99.pth.tar
# sbatch --time=5:00:00 --account=def-swasland-ab --gres=gpu:v100l:4 --mem=180G --nodes=1 --ntasks=1 --array=1-5%1 --job-name=fine1lr_e30_mink_segcontrast_w10 scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19641 --downstream --cfg_file configs/waymo_fine1lr_minkunet_segcontrast_waymo10.yaml --pretrained_ckpt checkpoint-ep99.pth.tar --epochs 30
# sbatch --time=5:00:00 --account=def-swasland-ab --gres=gpu:v100l:4 --mem=180G --nodes=1 --ntasks=1 --array=1-5%1 --job-name=fine1lr_e30_mink_iou_perc_0p3_w10 scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19651 --downstream --cfg_file configs/waymo_fine1lr_minkunet_iou_perc_0p3_waymo10.yaml --pretrained_ckpt checkpoint-ep99.pth.tar --epochs 30
# sbatch --time=5:00:00 --account=def-swasland-ab --gres=gpu:v100l:4 --mem=180G --nodes=1 --ntasks=1 --array=1-5%1 --job-name=fine1lr_e60_mink_segcontrast_w10 scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19641 --downstream --cfg_file configs/waymo_fine1lr_minkunet_segcontrast_waymo10.yaml --pretrained_ckpt checkpoint-ep99.pth.tar --epochs 60
# sbatch --time=5:00:00 --account=def-swasland-ab --gres=gpu:v100l:4 --mem=180G --nodes=1 --ntasks=1 --array=1-5%1 --job-name=fine1lr_e60_mink_iou_perc_0p3_w10 scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19651 --downstream --cfg_file configs/waymo_fine1lr_minkunet_iou_perc_0p3_waymo10.yaml --pretrained_ckpt checkpoint-ep99.pth.tar --epochs 60
# sbatch --time=5:00:00 --account=def-swasland-ab --gres=gpu:v100l:4 --mem=180G --nodes=1 --ntasks=1 --array=1-5%1 --job-name=fine1lr_e100_mink_segcontrast_w10 scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19641 --downstream --cfg_file configs/waymo_fine1lr_minkunet_segcontrast_waymo10.yaml --pretrained_ckpt checkpoint-ep99.pth.tar --epochs 100
# sbatch --time=5:00:00 --account=def-swasland-ab --gres=gpu:v100l:4 --mem=180G --nodes=1 --ntasks=1 --array=1-5%1 --job-name=fine1lr_e100_mink_iou_perc_0p3_w10 scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19651 --downstream --cfg_file configs/waymo_fine1lr_minkunet_iou_perc_0p3_waymo10.yaml --pretrained_ckpt checkpoint-ep99.pth.tar --epochs 100

# #minkunet finetune two lrs
# sbatch --time=5:00:00 --account=def-swasland-ab --gres=gpu:v100l:4 --mem=180G --nodes=1 --ntasks=1 --array=1-5%1 --job-name=fine2lrs_e15_mink_segcontrast_w10 scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19661 --downstream --cfg_file configs/waymo_fine2lrs_minkunet_segcontrast_waymo10.yaml --pretrained_ckpt checkpoint-ep99.pth.tar
# sbatch --time=5:00:00 --account=def-swasland-ab --gres=gpu:v100l:4 --mem=180G --nodes=1 --ntasks=1 --array=1-5%1 --job-name=fine2lrs_e15_mink_iou_perc_0p3_w10 scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19671 --downstream --cfg_file configs/waymo_fine2lrs_minkunet_iou_perc_0p3_waymo10.yaml --pretrained_ckpt checkpoint-ep99.pth.tar
# sbatch --time=5:00:00 --account=def-swasland-ab --gres=gpu:v100l:4 --mem=180G --nodes=1 --ntasks=1 --array=1-5%1 --job-name=fine2lrs_e30_mink_segcontrast_w10 scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19661 --downstream --cfg_file configs/waymo_fine2lrs_minkunet_segcontrast_waymo10.yaml --pretrained_ckpt checkpoint-ep99.pth.tar --epochs 30
# sbatch --time=5:00:00 --account=def-swasland-ab --gres=gpu:v100l:4 --mem=180G --nodes=1 --ntasks=1 --array=1-5%1 --job-name=fine2lrs_e30_mink_iou_perc_0p3_w10 scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19671 --downstream --cfg_file configs/waymo_fine2lrs_minkunet_iou_perc_0p3_waymo10.yaml --pretrained_ckpt checkpoint-ep99.pth.tar --epochs 30
# sbatch --time=5:00:00 --account=def-swasland-ab --gres=gpu:v100l:4 --mem=180G --nodes=1 --ntasks=1 --array=1-5%1 --job-name=fine2lrs_e60_mink_segcontrast_w10 scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19661 --downstream --cfg_file configs/waymo_fine2lrs_minkunet_segcontrast_waymo10.yaml --pretrained_ckpt checkpoint-ep99.pth.tar --epochs 60
# sbatch --time=5:00:00 --account=def-swasland-ab --gres=gpu:v100l:4 --mem=180G --nodes=1 --ntasks=1 --array=1-5%1 --job-name=fine2lrs_e60_mink_iou_perc_0p3_w10 scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19671 --downstream --cfg_file configs/waymo_fine2lrs_minkunet_iou_perc_0p3_waymo10.yaml --pretrained_ckpt checkpoint-ep99.pth.tar --epochs 60
# sbatch --time=5:00:00 --account=def-swasland-ab --gres=gpu:v100l:4 --mem=180G --nodes=1 --ntasks=1 --array=1-5%1 --job-name=fine2lrs_e100_mink_segcontrast_w10 scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19661 --downstream --cfg_file configs/waymo_fine2lrs_minkunet_segcontrast_waymo10.yaml --pretrained_ckpt checkpoint-ep99.pth.tar --epochs 100
# sbatch --time=5:00:00 --account=def-swasland-ab --gres=gpu:v100l:4 --mem=180G --nodes=1 --ntasks=1 --array=1-5%1 --job-name=fine2lrs_e100_mink_iou_perc_0p3_w10 scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19671 --downstream --cfg_file configs/waymo_fine2lrs_minkunet_iou_perc_0p3_waymo10.yaml --pretrained_ckpt checkpoint-ep99.pth.tar --epochs 100

# minkunet scratch
sbatch --time=5:00:00 --account=def-swasland-ab --gres=gpu:v100l:4 --mem=180G --nodes=1 --ntasks=1 --array=1-1%1 --job-name=scratch_mink_e15 scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19941 --downstream --cfg_file configs/waymo_scratch_minkunet.yaml --pretrained_ckpt checkpoint-ep0.pth.tar
sbatch --time=2:00:00 --dependency=afterok:21730724 --account=def-swasland-ab --gres=gpu:v100l:4 --mem=180G --nodes=1 --ntasks=1 --array=1-1%1 --job-name=scratch_mink_e30 scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19941 --downstream --cfg_file configs/waymo_scratch_minkunet.yaml --pretrained_ckpt checkpoint-ep0.pth.tar --epochs 30
sbatch --time=4:00:00 --dependency=afterok:21742792 --account=def-swasland-ab --gres=gpu:v100l:4 --mem=180G --nodes=1 --ntasks=1 --array=1-1%1 --job-name=scratch_mink_e60 scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19941 --downstream --cfg_file configs/waymo_scratch_minkunet.yaml --pretrained_ckpt checkpoint-ep0.pth.tar --epochs 60
sbatch --time=6:00:00 --dependency=afterok:21742802 --account=def-swasland-ab --gres=gpu:v100l:4 --mem=180G --nodes=1 --ntasks=1 --array=1-2%1 --job-name=scratch_mink_e100 scripts/submit_ddp_compute_canada_waymo_multinode.sh --tcp_port 19941 --downstream --cfg_file configs/waymo_scratch_minkunet.yaml --pretrained_ckpt checkpoint-ep0.pth.tar --epochs 100

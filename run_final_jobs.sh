...
scripts/submit_ddp_turing_finetune_5perc.sh --mode s  \
    ...
    --finetune_epochs 30 \
    --extra_tag try_0 \
    > ./output/log/waymo_minkunet_scratch_wns_5_perc_30ep_try_0_$(date +%Y-%m-%d_%H:%M).out 2>&1
...
#scratch nuscenes 1 percent for 100 ep with 16 bs

...
#SegContrast
sbatch --time=10:00:00 --array=1-5%1 --job-name=seg_1in2_cube_up_dense_kitti --mail-user=barzanisar93@gmail.com scripts/compute_canada_train_depth_contrast_dense_kitti.sh --cluster --tcp_port 18969 --cfg_file configs/pointnet_train_all_FOV3000_60/seg/seg_1in2_cube_up_dense_kitti.yaml
sbatch --time=10:00:00 --array=1-5%1 --job-name=seg_dense_kitti --mail-user=barzanisar93@gmail.com scripts/compute_canada_train_depth_contrast_dense_kitti.sh --cluster --tcp_port 18660 --cfg_file configs/pointnet_train_all_FOV3000_60/seg/seg_dense_kitti.yaml

...
#SegContrast
sbatch --time=01:00:00 --array=1-1%1 --job-name=seg_1in2_cube_up_dense_semkitti --mail-user=barzanisar93@gmail.com scripts/compute_canada_train_depth_contrast_dense_semkitti.sh --cluster --tcp_port 18849 --cfg_file configs/pointnet_train_all_FOV3000_60/seg/seg_1in2_cube_up_dense_semkitti.yaml
sbatch --time=01:00:00 --array=1-1%1 --job-name=seg_dense_semkitti --mail-user=barzanisar93@gmail.com scripts/compute_canada_train_depth_contrast_dense_semkitti.sh --cluster --tcp_port 18840 --cfg_file configs/pointnet_train_all_FOV3000_60/seg/seg_dense_semkitti.yaml

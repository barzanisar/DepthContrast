...
def point_moco_collator(batch):
    ...
    output_batch = {'input': {'points': points, 'gt_boxes': batch_gt_boxes3d, 'gt_boxes_idx': batch_gt_boxes_idx, 'batch_size': batch_size},
                    'input_moco': {'points': points_moco, 'gt_boxes': batch_gt_boxes3d_moco, 'gt_boxes_idx': batch_gt_boxes_moco_idx,'batch_size': batch_size}
    }

...
from lib.LiDAR_snow_sim.tools.wet_ground.utils import plot_2d_hist
from lib.LiDAR_snow_sim.tools.wet_ground.planes import calculate_plane
from lib.LiDAR_snow_sim.tools.wet_ground.phy_equations import total_transmittance_from_ground
...
def estimate_laser_parameters(pointcloud_planes, calculated_indicent_angle, power_factor=15, noise_floor=0.7,
    ...
    x = (xedges[idx[0]] + xedges[idx1[0]]) / 2

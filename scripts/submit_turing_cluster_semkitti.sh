...
NUSCENES_DATA_DIR=/raid/datasets/semantic_kitti:/DepthContrast/data/semantic_kitti
...
CMD=$BASE_CMD
CMD+="python /DepthContrast/tools/cluster_semkitti.py --start_seq_idx $START_IDX --end_seq_idx $END_IDX --eps $EPS"

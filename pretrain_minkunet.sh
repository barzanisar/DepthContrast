...
sbatch --time=00:45:00 --nodes=1 --ntasks=1 --array=1-1%1 --job-name=mink_esf_perc_0p05_iou_wt_w5_bs16 scripts/submit_ddp_cedar.sh --tcp_port 19833 --cfg_file configs/waymo_minkunet_esf_perc_0p05_iou_wt_waymo5.yaml
sbatch --time=00:45:00 --nodes=1 --ntasks=1 --array=1-1%1 --job-name=mink_esf_perc_0p05_iou_wt_w5_bs12 scripts/submit_ddp_cedar.sh --tcp_port 19834 --cfg_file configs/waymo_minkunet_esf_perc_0p05_iou_wt_waymo5_bs12.yaml
sbatch --time=00:45:00 --nodes=1 --ntasks=1 --array=1-1%1 --job-name=mink_esf_perc_0p05_iou_wt_w5_bs10 scripts/submit_ddp_cedar.sh --tcp_port 19835 --cfg_file configs/waymo_minkunet_esf_perc_0p05_iou_wt_waymo5_bs10.yaml
sbatch --time=00:45:00 --nodes=1 --ntasks=1 --array=1-1%1 --job-name=mink_esf_perc_0p05_iou_wt_w5_bs8 scripts/submit_ddp_cedar.sh --tcp_port 19836 --cfg_file configs/waymo_minkunet_esf_perc_0p05_iou_wt_waymo5_bs8.yaml

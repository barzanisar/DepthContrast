...
sbatch --time=6:00:00 --array=1-6%1 --job-name=mink_esf_perc_0p01_w5 scripts/submit_ddp_cedar.sh --tcp_port 19831 --cfg_file configs/waymo_minkunet_esf_perc_0p01_waymo5.yaml
sbatch --time=6:00:00 --array=1-6%1 --job-name=mink_esf_perc_0p05_w5 scripts/submit_ddp_cedar.sh --tcp_port 19832 --cfg_file configs/waymo_minkunet_esf_perc_0p05_waymo5.yaml
sbatch --time=00:45:00 --array=1-1%1 --job-name=mink_esf_perc_0p05_iou_wt_w5_bs8 scripts/submit_ddp_cedar.sh --tcp_port 19834 --cfg_file configs/waymo_minkunet_esf_perc_0p05_iou_wt_waymo5_bs8.yaml
sbatch --time=00:45:00 --array=1-1%1 --job-name=mink_esf_perc_0p05_iou_wt_w5 scripts/submit_ddp_cedar.sh --tcp_port 19833 --cfg_file configs/waymo_minkunet_esf_perc_0p05_iou_wt_waymo5.yaml
sbatch --time=6:00:00 --array=1-6%1 --job-name=mink_esf_perc_0p05_esf_wt_w5 scripts/submit_ddp_cedar.sh --tcp_port 19834 --cfg_file configs/waymo_minkunet_esf_perc_0p05_esf_wt_waymo5.yaml
sbatch --time=6:00:00 --array=1-6%1 --job-name=mink_esf_perc_0p05_w5_t0p04 scripts/submit_ddp_cedar.sh --tcp_port 19835 --cfg_file configs/waymo_minkunet_esf_perc_0p05_waymo5_t0p04.yaml
sbatch --time=6:00:00 --array=1-6%1 --job-name=mink_esf_perc_0p05_w5_t0p07 scripts/submit_ddp_cedar.sh --tcp_port 19836 --cfg_file configs/waymo_minkunet_esf_perc_0p05_waymo5_t0p07.yaml

sbatch --time=6:00:00 --array=1-6%1 --job-name=mink_iou_perc_0p01_w5 scripts/submit_ddp_cedar.sh --tcp_port 19837 --cfg_file configs/waymo_minkunet_iou_perc_0p01_waymo5.yaml
sbatch --time=6:00:00 --array=1-6%1 --job-name=mink_iou_perc_0p05_w5 scripts/submit_ddp_cedar.sh --tcp_port 19838 --cfg_file configs/waymo_minkunet_iou_perc_0p05_waymo5.yaml
sbatch --time=6:00:00 --array=1-6%1 --job-name=mink_iou_perc_0p01_iou_wt_w5 scripts/submit_ddp_cedar.sh --tcp_port 19839 --cfg_file configs/waymo_minkunet_iou_perc_0p01_iou_wt_waymo5.yaml
sbatch --time=6:00:00 --array=1-6%1 --job-name=mink_iou_perc_0p01_esf_wt_w5 scripts/submit_ddp_cedar.sh --tcp_port 19840 --cfg_file configs/waymo_minkunet_iou_perc_0p01_esf_wt_waymo5.yaml
sbatch --time=6:00:00 --array=1-6%1 --job-name=mink_iou_perc_0p01_w5_t0p04 scripts/submit_ddp_cedar.sh --tcp_port 19841 --cfg_file configs/waymo_minkunet_iou_perc_0p01_waymo5_t0p04.yaml
sbatch --time=6:00:00 --array=1-6%1 --job-name=mink_iou_perc_0p01_w5_t0p07 scripts/submit_ddp_cedar.sh --tcp_port 19842 --cfg_file configs/waymo_minkunet_iou_perc_0p01_waymo5_t0p07.yaml

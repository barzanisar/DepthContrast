...
# sbatch --time=10:00:00 --array=1-6%1 --job-name=dc scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19558 --cfg_file configs/waymo_minkunet_depthcontrast_waymo14.yaml --model_name minkunet_pretrain_depthcontrast_waymo14 --pretrained_ckpt checkpoint-ep99.pth.tar --other_datasets
# sbatch --time=10:00:00 --array=1-7%1 --job-name=dc_lidaraug_dethead scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19559 --cfg_file configs/waymo_minkunet_depthcontrast_waymo14_lidar_aug_dethead_0p8w.yaml --model_name minkunet_pretrain_depthcontrast_waymo14_lidar_aug_dethead_0p8w --pretrained_ckpt checkpoint-ep99.pth.tar --other_datasets

# sbatch --time=10:00:00 --array=1-6%1 --job-name=sc scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19560 --cfg_file configs/waymo_minkunet_segcontrast_waymo14.yaml --model_name minkunet_pretrain_segcontrast_waymo14 --pretrained_ckpt checkpoint-ep99.pth.tar --other_datasets
# sbatch --time=10:00:00 --array=1-7%1 --job-name=sc_lidaraug_dethead scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19561 --cfg_file configs/waymo_minkunet_segcontrast_waymo14_lidar_aug_dethead_0p8w.yaml --model_name minkunet_pretrain_segcontrast_waymo14_lidar_aug_dethead_0p8w --pretrained_ckpt checkpoint-ep99.pth.tar --other_datasets
sbatch --time=10:00:00 --array=1-7%1 --job-name=sc_lidaraug scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19562 --cfg_file configs/waymo_minkunet_segcontrast_waymo14_lidar_aug.yaml --model_name minkunet_pretrain_segcontrast_waymo14_lidar_aug --pretrained_ckpt checkpoint-ep99.pth.tar --other_datasets
sbatch --time=10:00:00 --array=1-6%1 --job-name=sc_dethead scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19563 --cfg_file configs/waymo_minkunet_segcontrast_waymo14_dethead_0p8w.yaml --model_name minkunet_pretrain_segcontrast_waymo14_dethead_0p8w --pretrained_ckpt checkpoint-ep99.pth.tar --other_datasets
...
# sbatch --time=10:00:00 --array=1-6%1 --job-name=scratch_seg_try2 scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19570 --cfg_file configs/waymo_scratch_minkunet.yaml --finetune_epochs 15 --finetune_batchsize_per_gpu 8 --other_datasets --downstream_model_dir scratch_epochs15_try2

sbatch --time=10:00:00 --array=1-6%1 --job-name=scratch_seg scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19570 --cfg_file configs/waymo_scratch_minkunet.yaml --finetune_epochs 15 --finetune_batchsize_per_gpu 8 --other_datasets --downstream_model_dir scratch_epochs15

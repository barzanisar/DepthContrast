...
sbatch --time=6:00:00 --array=1-4%1 --job-name=mink_iou_knn_0p15_esf_owt_waymo5_t0p04 scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19846 --cfg_file configs/waymo_minkunet_iou_knn_0p15_esf_owt_waymo5_t0p04.yaml --model_name minkunet_pretrain_iou_knn_0p15_iou_owt_waymo5_t0p04 --pretrained_ckpt checkpoint-ep49.pth.tar 
sbatch --time=6:00:00 --array=1-4%1 --job-name=mink_2_iou_knn_0p15_esf_owt_waymo5_t0p04 scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19847 --cfg_file configs/waymo_minkunet_iou_knn_0p15_esf_owt_waymo5_t0p04.yaml --model_name minkunet_pretrain_iou_knn_0p15_iou_owt_waymo5_t0p04_try2 --pretrained_ckpt checkpoint-ep49.pth.tar 

sbatch --time=6:00:00 --array=1-4%1 --job-name=mink_iou_knn_0p15_esf_iwt_waymo5_t0p04 scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19848 --cfg_file configs/waymo_minkunet_iou_knn_0p15_esf_iwt_waymo5_t0p04.yaml --model_name minkunet_pretrain_iou_knn_0p15_iou_iwt_waymo5_t0p04 --pretrained_ckpt checkpoint-ep49.pth.tar 
sbatch --time=6:00:00 --array=1-4%1 --job-name=mink_2_iou_knn_0p15_esf_iwt_waymo5_t0p04 scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19849 --cfg_file configs/waymo_minkunet_iou_knn_0p15_esf_iwt_waymo5_t0p04.yaml --model_name minkunet_pretrain_iou_knn_0p15_iou_iwt_waymo5_t0p04_try2 --pretrained_ckpt checkpoint-ep49.pth.tar 

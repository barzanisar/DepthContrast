...
## Try1
sbatch --time=4:00:00 --array=1-1%1 --job-name=dc_waymo10_50epochs scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19558 --cfg_file configs/waymo_minkunet_depthcontrast_waymo10.yaml --model_name minkunet_pretrain_depthcontrast_waymo10 --pretrained_ckpt checkpoint-ep49.pth.tar --other_datasets
sbatch --time=10:00:00 --array=1-1%1 --job-name=dc_lidaraug_dethead_waymo10_50epochs scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19559 --cfg_file configs/waymo_minkunet_depthcontrast_waymo10_lidar_aug_dethead_0p8w.yaml --model_name minkunet_pretrain_depthcontrast_waymo10_lidar_aug_dethead_0p8w --pretrained_ckpt checkpoint-ep49.pth.tar --other_datasets

sbatch --time=4:00:00 --array=1-1%1 --job-name=sc_waymo10_50epochs scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19560 --cfg_file configs/waymo_minkunet_segcontrast_waymo10.yaml --model_name minkunet_pretrain_segcontrast_waymo10 --pretrained_ckpt checkpoint-ep49.pth.tar --other_datasets
sbatch --time=4:00:00 --array=1-1%1 --job-name=sc_lidaraug_dethead_waymo10_50epochs scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19561 --cfg_file configs/waymo_minkunet_segcontrast_waymo10_lidar_aug_dethead_0p8w.yaml --model_name minkunet_pretrain_segcontrast_waymo10_lidar_aug_dethead_0p8w --pretrained_ckpt checkpoint-ep49.pth.tar --other_datasets
sbatch --time=4:00:00 --array=1-1%1 --job-name=sc_lidaraug_waymo10_50epochs scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19562 --cfg_file configs/waymo_minkunet_segcontrast_waymo10_lidar_aug.yaml --model_name minkunet_pretrain_segcontrast_waymo10_lidar_aug --pretrained_ckpt checkpoint-ep49.pth.tar --other_datasets
sbatch --time=10:00:00 --array=1-1%1 --job-name=sc_dethead_waymo10_50epochs scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19563 --cfg_file configs/waymo_minkunet_segcontrast_waymo10_dethead_0p8w.yaml --model_name minkunet_pretrain_segcontrast_waymo10_dethead_0p8w --pretrained_ckpt checkpoint-ep49.pth.tar --other_datasets
sbatch --time=6:00:00 --array=1-1%1 --job-name=sc_iouknn_waymo10_50epochs scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19564 --cfg_file configs/waymo_minkunet_segcontrast_waymo10_iou_knn_weight.yaml --model_name minkunet_pretrain_segcontrast_waymo10_iou_knn_weight --pretrained_ckpt checkpoint-ep49.pth.tar --other_datasets
sbatch --time=10:00:00 --array=1-1%1 --job-name=sc_all_50epochs scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19565 --cfg_file configs/waymo_minkunet_segcontrast_waymo10_lidar_aug_dethead_0p8w_iou_knn_weight.yaml --model_name minkunet_pretrain_segcontrast_waymo10_lidar_aug_dethead_0p8w_iou_knn_weight --pretrained_ckpt checkpoint-ep49.pth.tar --other_datasets

sbatch --time=4:00:00 --array=1-1%1 --job-name=scratch_seg scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19570 --cfg_file configs/waymo_scratch_minkunet.yaml --mode scratch --finetune_epochs 15 --other_datasets --downstream_model_dir scratch_epochs15
sbatch --time=4:00:00 --array=1-1%1 --job-name=scratch_seg_5percent scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19571 --cfg_file configs/waymo_scratch_minkunet.yaml --mode scratch --finetune_epochs 15 --other_datasets --downstream_model_dir scratch_5percent --frame_sampling_div 5
...
### Try 2
sbatch --time=8:00:00 --array=1-5%1 --job-name=t2_dc_waymo10_50epochs scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19658 --cfg_file configs/waymo_minkunet_depthcontrast_waymo10.yaml --model_name minkunet_pretrain_depthcontrast_waymo10_try2 --pretrained_ckpt checkpoint-ep49.pth.tar --other_datasets
sbatch --time=8:00:00 --array=1-5%1 --job-name=t2_dc_lidaraug_dethead_waymo10_50epochs scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19659 --cfg_file configs/waymo_minkunet_depthcontrast_waymo10_lidar_aug_dethead_0p8w.yaml --model_name minkunet_pretrain_depthcontrast_waymo10_lidar_aug_dethead_0p8w_try2 --pretrained_ckpt checkpoint-ep49.pth.tar --other_datasets

sbatch --time=8:00:00 --array=1-5%1 --job-name=t2_sc_waymo10_50epochs scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19660 --cfg_file configs/waymo_minkunet_segcontrast_waymo10.yaml --model_name minkunet_pretrain_segcontrast_waymo10_try2 --pretrained_ckpt checkpoint-ep49.pth.tar --other_datasets
sbatch --time=8:00:00 --array=1-5%1 --job-name=t2_sc_lidaraug_dethead_waymo10_50epochs scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19661 --cfg_file configs/waymo_minkunet_segcontrast_waymo10_lidar_aug_dethead_0p8w.yaml --model_name minkunet_pretrain_segcontrast_waymo10_lidar_aug_dethead_0p8w_try2 --pretrained_ckpt checkpoint-ep49.pth.tar --other_datasets
sbatch --time=8:00:00 --array=1-5%1 --job-name=t2_sc_lidaraug_waymo10_50epochs scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19662 --cfg_file configs/waymo_minkunet_segcontrast_waymo10_lidar_aug.yaml --model_name minkunet_pretrain_segcontrast_waymo10_lidar_aug_try2 --pretrained_ckpt checkpoint-ep49.pth.tar --other_datasets
sbatch --time=8:00:00 --array=1-5%1 --job-name=t2_sc_dethead_waymo10_50epochs scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19663 --cfg_file configs/waymo_minkunet_segcontrast_waymo10_dethead_0p8w.yaml --model_name minkunet_pretrain_segcontrast_waymo10_dethead_0p8w_try2 --pretrained_ckpt checkpoint-ep49.pth.tar --other_datasets
sbatch --time=8:00:00 --array=1-5%1 --job-name=t2_sc_iouknn_waymo10_50epochs scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19664 --cfg_file configs/waymo_minkunet_segcontrast_waymo10_iou_knn_weight.yaml --model_name minkunet_pretrain_segcontrast_waymo10_iou_knn_weight_try2 --pretrained_ckpt checkpoint-ep49.pth.tar --other_datasets
sbatch --time=8:00:00 --array=1-5%1 --job-name=t2_sc_all_50epochs scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19665 --cfg_file configs/waymo_minkunet_segcontrast_waymo10_lidar_aug_dethead_0p8w_iou_knn_weight.yaml --model_name minkunet_pretrain_segcontrast_waymo10_lidar_aug_dethead_0p8w_iou_knn_weight_try2 --pretrained_ckpt checkpoint-ep49.pth.tar --other_datasets

sbatch --time=3:00:00 --array=1-1%1 --job-name=t2_scratch_seg scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19670 --cfg_file configs/waymo_scratch_minkunet.yaml --mode scratch --finetune_epochs 15 --other_datasets --downstream_model_dir scratch_1percent_vs0p1_try2
sbatch --time=3:00:00 --array=1-1%1 --job-name=t2_scratch_seg_5percent scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19671 --cfg_file configs/waymo_scratch_minkunet.yaml --mode scratch --finetune_epochs 15 --other_datasets --downstream_model_dir scratch_5percent_vs0p1_try2 --frame_sampling_div 5

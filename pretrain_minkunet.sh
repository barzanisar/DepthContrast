...
sbatch --time=10:00:00 --array=1-6%1 --job-name=scratch_seg scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19570 --cfg_file configs/waymo_scratch_minkunet.yaml --finetune_epochs 15 --other_datasets --downstream_model_dir scratch_epochs15

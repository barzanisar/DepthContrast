...
sbatch --time=6:00:00 --array=1-24%1 --job-name=sc_lidaraug scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19562 --cfg_file configs/waymo_minkunet_segcontrast_waymo14_lidar_aug.yaml --model_name minkunet_pretrain_segcontrast_waymo14_lidar_aug --pretrained_ckpt checkpoint-ep99.pth.tar --other_datasets
sbatch --time=6:00:00 --array=1-24%1 --job-name=sc_dethead scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19563 --cfg_file configs/waymo_minkunet_segcontrast_waymo14_dethead_0p8w.yaml --model_name minkunet_pretrain_segcontrast_waymo14_dethead_0p8w --pretrained_ckpt checkpoint-ep99.pth.tar --other_datasets
...
sbatch --time=80:00:00 --array=1-1%1 --job-name=scratch_seg scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19570 --cfg_file configs/waymo_scratch_minkunet.yaml --mode scratch --finetune_epochs 15 --other_datasets --downstream_model_dir scratch_epochs15

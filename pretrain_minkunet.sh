...
sbatch --time=6:00:00 --array=1-7%1 --job-name=mink_segcontrast scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19843 --cfg_file configs/waymo_minkunet_segcontrast_waymo5.yaml --model_name minkunet_pretrain_segcontrast_waymo5 --pretrained_ckpt checkpoint-ep49.pth.tar 

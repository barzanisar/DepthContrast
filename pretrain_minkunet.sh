...
sbatch --time=10:00:00 --array=1-4%1 --job-name=mink_iou_knn_0p01_filter_w5_t0p04 scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19768 --cfg_file configs/waymo_minkunet_iou_knn_0p01_filter_waymo5_t0p04.yaml --model_name minkunet_pretrain_iou_knn_0p01_filter_waymo5_t0p04 --pretrained_ckpt checkpoint-ep49.pth.tar
...
###########
sbatch --time=10:00:00 --array=1-4%1 --job-name=mink_esf_knn_0p03_weight_w5_t0p04 scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19755 --cfg_file configs/waymo_minkunet_esf_knn_0p03_weight_waymo5_t0p04.yaml --model_name minkunet_pretrain_esf_knn_0p03_weight_waymo5_t0p04 --pretrained_ckpt checkpoint-ep49.pth.tar
sbatch --time=10:00:00 --array=1-4%1 --job-name=mink_esf_knn_0p03_filter_w5_t0p04 scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19756 --cfg_file configs/waymo_minkunet_esf_knn_0p03_filter_waymo5_t0p04.yaml --model_name minkunet_pretrain_esf_knn_0p03_filter_waymo5_t0p04 --pretrained_ckpt checkpoint-ep49.pth.tar
sbatch --time=10:00:00 --array=1-4%1 --job-name=mink_esf_knn_0p01_weight_w5_t0p04 scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19757 --cfg_file configs/waymo_minkunet_esf_knn_0p01_weight_waymo5_t0p04.yaml --model_name minkunet_pretrain_esf_knn_0p01_weight_waymo5_t0p04 --pretrained_ckpt checkpoint-ep49.pth.tar
sbatch --time=10:00:00 --array=1-4%1 --job-name=mink_esf_knn_0p01_filter_w5_t0p04 scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19758 --cfg_file configs/waymo_minkunet_esf_knn_0p01_filter_waymo5_t0p04.yaml --model_name minkunet_pretrain_esf_knn_0p01_filter_waymo5_t0p04 --pretrained_ckpt checkpoint-ep49.pth.tar

...
sbatch --time=10:00:00 --array=1-4%1 --job-name=lidar_aug_try2 scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19844 --cfg_file configs/waymo_minkunet_segcontrast_lidar_aug_waymo5_t0p04.yaml --model_name minkunet_pretrain_segcontrast_lidar_aug_waymo5_t0p04_try2 --pretrained_ckpt checkpoint-ep49.pth.tar 
...
sbatch --time=10:00:00 --array=1-4%1 --job-name=mink_iouplusesf_knn_0p01_weight_w5_t0p02_try2 scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19857 --cfg_file configs/waymo_minkunet_iou_plus_esf_knn_0p01_weight_waymo5_t0p02.yaml --model_name minkunet_pretrain_iou_plus_esf_knn_0p01_weight_waymo5_t0p02_try2 --pretrained_ckpt checkpoint-ep49.pth.tar 

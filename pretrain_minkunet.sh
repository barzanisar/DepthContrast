...
sbatch --time=10:00:00 --array=1-4%1 --job-name=dc scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19558 --cfg_file configs/waymo_minkunet_depthcontrast_waymo14.yaml --model_name minkunet_pretrain_depthcontrast_waymo14 --pretrained_ckpt checkpoint-ep49.pth.tar 
sbatch --time=10:00:00 --array=1-4%1 --job-name=dc_lidaraug_dethead scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19559 --cfg_file configs/waymo_minkunet_depthcontrast_waymo14_lidar_aug_dethead_0p8w.yaml --model_name minkunet_pretrain_depthcontrast_waymo14_lidar_aug_dethead_0p8w --pretrained_ckpt checkpoint-ep49.pth.tar 

sbatch --time=10:00:00 --array=1-4%1 --job-name=sc scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19560 --cfg_file configs/waymo_minkunet_segcontrast_waymo14.yaml --model_name minkunet_pretrain_segcontrast_waymo14 --pretrained_ckpt checkpoint-ep49.pth.tar 
sbatch --time=10:00:00 --array=1-4%1 --job-name=sc_lidaraug_dethead scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19561 --cfg_file configs/waymo_minkunet_segcontrast_waymo14_lidar_aug_dethead_0p8w.yaml --model_name minkunet_pretrain_segcontrast_waymo14_lidar_aug_dethead_0p8w --pretrained_ckpt checkpoint-ep49.pth.tar 
sbatch --time=10:00:00 --array=1-4%1 --job-name=sc_lidaraug scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19562 --cfg_file configs/waymo_minkunet_segcontrast_waymo14_lidar_aug.yaml --model_name minkunet_pretrain_segcontrast_waymo14_lidar_aug --pretrained_ckpt checkpoint-ep49.pth.tar 
sbatch --time=10:00:00 --array=1-4%1 --job-name=sc_dethead scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19563 --cfg_file configs/waymo_minkunet_segcontrast_waymo14_dethead_0p8w.yaml --model_name minkunet_pretrain_segcontrast_waymo14_dethead_0p8w --pretrained_ckpt checkpoint-ep49.pth.tar 


sbatch --time=10:00:00 --array=1-4%1 --job-name=dc_try2 scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19564 --cfg_file configs/waymo_minkunet_depthcontrast_waymo14.yaml --model_name minkunet_pretrain_depthcontrast_waymo14_try2 --pretrained_ckpt checkpoint-ep49.pth.tar 
sbatch --time=10:00:00 --array=1-4%1 --job-name=dc_lidaraug_dethead_try2 scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19565 --cfg_file configs/waymo_minkunet_depthcontrast_waymo14_lidar_aug_dethead_0p8w.yaml --model_name minkunet_pretrain_depthcontrast_waymo14_lidar_aug_dethead_0p8w_try2 --pretrained_ckpt checkpoint-ep49.pth.tar 

sbatch --time=10:00:00 --array=1-4%1 --job-name=sc_try2 scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19566 --cfg_file configs/waymo_minkunet_segcontrast_waymo14.yaml --model_name minkunet_pretrain_segcontrast_waymo14_try2 --pretrained_ckpt checkpoint-ep49.pth.tar 
sbatch --time=10:00:00 --array=1-4%1 --job-name=sc_lidaraug_dethead_try2 scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19567 --cfg_file configs/waymo_minkunet_segcontrast_waymo14_lidar_aug_dethead_0p8w.yaml --model_name minkunet_pretrain_segcontrast_waymo14_lidar_aug_dethead_0p8w_try2 --pretrained_ckpt checkpoint-ep49.pth.tar 
sbatch --time=10:00:00 --array=1-4%1 --job-name=sc_lidaraug_try2 scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19568 --cfg_file configs/waymo_minkunet_segcontrast_waymo14_lidar_aug.yaml --model_name minkunet_pretrain_segcontrast_waymo14_lidar_aug_try2 --pretrained_ckpt checkpoint-ep49.pth.tar 
sbatch --time=10:00:00 --array=1-4%1 --job-name=sc_dethead_try2 scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19569 --cfg_file configs/waymo_minkunet_segcontrast_waymo14_dethead_0p8w.yaml --model_name minkunet_pretrain_segcontrast_waymo14_dethead_0p8w_try2 --pretrained_ckpt checkpoint-ep49.pth.tar 

...
## Try1
sbatch --time=8:00:00 --array=1-1%1 --job-name=dc_waymo10_50epochs scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19558 --cfg_file configs/waymo_minkunet_depthcontrast_waymo10.yaml --model_name minkunet_pretrain_depthcontrast_waymo10 --pretrained_ckpt checkpoint-ep49.pth.tar --other_datasets
...
sbatch --time=8:00:00 --array=1-1%1 --job-name=sc_waymo10_50epochs scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19560 --cfg_file configs/waymo_minkunet_segcontrast_waymo10.yaml --model_name minkunet_pretrain_segcontrast_waymo10 --pretrained_ckpt checkpoint-ep49.pth.tar --other_datasets
...
sbatch --time=8:00:00 --array=1-10%1 --job-name=sc_iouknn_waymo10_50epochs scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19564 --cfg_file configs/waymo_minkunet_segcontrast_waymo10_iou_knn_weight.yaml --model_name minkunet_pretrain_segcontrast_waymo10_iou_knn_weight --pretrained_ckpt checkpoint-ep49.pth.tar --other_datasets
sbatch --time=8:00:00 --array=1-10%1 --job-name=sc_all_50epochs scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19565 --cfg_file configs/waymo_minkunet_segcontrast_waymo10_lidar_aug_dethead_0p8w_iou_knn_weight.yaml --model_name minkunet_pretrain_segcontrast_waymo10_lidar_aug_dethead_0p8w_iou_knn_weight --pretrained_ckpt checkpoint-ep49.pth.tar --other_datasets
...
sbatch --time=8:00:00 --array=1-1%1 --job-name=scratch_seg_5percent scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19571 --cfg_file configs/waymo_scratch_minkunet.yaml --mode scratch --finetune_epochs 15 --other_datasets --downstream_model_dir scratch_5percent --frame_sampling_div 5
...
sbatch --time=8:00:00 --array=1-1%1 --job-name=t2_scratch_seg scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19670 --cfg_file configs/waymo_scratch_minkunet.yaml --mode scratch --finetune_epochs 15 --other_datasets --downstream_model_dir scratch_epochs15_try2
sbatch --time=8:00:00 --array=1-1%1 --job-name=t2_scratch_seg_5percent scripts/submit_ddp_$CLUSTER_NAME.sh --tcp_port 19671 --cfg_file configs/waymo_scratch_minkunet.yaml --mode scratch --finetune_epochs 15 --other_datasets --downstream_model_dir scratch_5percent_try2 --frame_sampling_div 5

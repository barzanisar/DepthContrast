...
scripts/submit_ddp_$CLUSTER_NAME.sh --num_gpus 2 --cuda_visible_devices 0,1 --tcp_port 19835 --cfg_file configs/waymo_minkunet_iouANDesf_knn_0p23_iou_iwt_waymo5_t0p04_warmup_cuboid.yaml --pretrain_batchsize_per_gpu 16 --finetune_batchsize_per_gpu 8 --model_name minkunet_pretrain_iouANDesf_knn_0p23_iou_iwt_waymo5_t0p04_warmup_cuboid --pretrained_ckpt checkpoint-ep50.pth.tar > ./output/log/minkunet_pretrain_iouANDesf_knn_0p23_iou_iwt_waymo5_t0p04_warmup_cuboid_$(date +%Y-%m-%d_%H:%M).out 2>&1
scripts/submit_ddp_$CLUSTER_NAME.sh --num_gpus 2 --cuda_visible_devices 2,3 --tcp_port 19836 --cfg_file configs/waymo_minkunet_iouANDesf_knn_0p23_iou_iwt_waymo5_t0p04_warmup.yaml --pretrain_batchsize_per_gpu 16 --finetune_batchsize_per_gpu 8 --model_name minkunet_pretrain_iouANDesf_knn_0p23_iou_iwt_waymo5_t0p04_warmup --pretrained_ckpt checkpoint-ep50.pth.tar > ./output/log/minkunet_pretrain_iouANDesf_knn_0p23_iou_iwt_waymo5_t0p04_warmup_$(date +%Y-%m-%d_%H:%M).out 2>&1

scripts/submit_ddp_$CLUSTER_NAME.sh --num_gpus 2 --cuda_visible_devices 0,1 --tcp_port 19835 --cfg_file configs/waymo_minkunet_iouANDesf_knn_0p15_iou_iwt_waymo5_t0p04.yaml --pretrain_batchsize_per_gpu 16 --finetune_batchsize_per_gpu 8 --model_name minkunet_pretrain_iouANDesf_knn_0p15_iou_iwt_waymo5_t0p04 --pretrained_ckpt checkpoint-ep49.pth.tar > ./output/log/minkunet_pretrain_iouANDesf_knn_0p15_iou_iwt_waymo5_t0p04_$(date +%Y-%m-%d_%H:%M).out 2>&1
scripts/submit_ddp_$CLUSTER_NAME.sh --num_gpus 2 --cuda_visible_devices 2,3 --tcp_port 19836 --cfg_file configs/waymo_minkunet_iou_knn_0p03_iou_iwt_waymo5_t0p02.yaml --pretrain_batchsize_per_gpu 16 --finetune_batchsize_per_gpu 8 --model_name minkunet_pretrain_iou_knn_0p03_iou_iwt_waymo5_t0p02 --pretrained_ckpt checkpoint-ep49.pth.tar > ./output/log/minkunet_pretrain_iou_knn_0p03_iou_iwt_waymo5_t0p02_$(date +%Y-%m-%d_%H:%M).out 2>&1
...
scripts/submit_ddp_$CLUSTER_NAME.sh --num_gpus 4 --cuda_visible_devices 0,1,2,3 --tcp_port 19836 --cfg_file configs/waymo_minkunet_segcontrast_waymo15_t0p04.yaml --pretrain_batchsize_per_gpu 8 --finetune_batchsize_per_gpu 4 --model_name minkunet_pretrain_segcontrast_waymo15_t0p04 --pretrained_ckpt checkpoint-ep49.pth.tar > ./output/log/minkunet_pretrain_segcontrast_waymo15_t0p04_$(date +%Y-%m-%d_%H:%M).out 2>&1

scripts/submit_ddp_turing.sh --num_gpus 2 --cuda_visible_devices 0,1 --tcp_port 19835 --cfg_file configs/waymo_minkunet_segcontrast_waymo5_dethead_0p8w.yaml --pretrain_batchsize_per_gpu 16 --finetune_batchsize_per_gpu 8 --model_name minkunet_pretrain_segcontrast_waymo5_dethead_0p8w --pretrained_ckpt checkpoint-ep49.pth.tar > ./output/log/minkunet_pretrain_segcontrast_waymo5_dethead_0p8w_$(date +%Y-%m-%d_%H:%M).out 2>&1
scripts/submit_ddp_turing.sh --num_gpus 2 --cuda_visible_devices 2,3 --tcp_port 19836 --cfg_file configs/waymo_minkunet_segcontrast_waymo5_dethead_0p8w.yaml --pretrain_batchsize_per_gpu 16 --finetune_batchsize_per_gpu 8 --model_name minkunet_pretrain_segcontrast_waymo5_dethead_0p8w_try2 --pretrained_ckpt checkpoint-ep49.pth.tar > ./output/log/minkunet_pretrain_segcontrast_waymo5_dethead_0p8w_try2_$(date +%Y-%m-%d_%H:%M).out 2>&1

scripts/submit_ddp_turing.sh --num_gpus 2 --cuda_visible_devices 0,1 --tcp_port 19835 --cfg_file configs/waymo_minkunet_segcontrast_waymo5_dethead_1w.yaml --pretrain_batchsize_per_gpu 16 --finetune_batchsize_per_gpu 8 --model_name minkunet_pretrain_segcontrast_waymo5_dethead_1w --pretrained_ckpt checkpoint-ep49.pth.tar > ./output/log/minkunet_pretrain_segcontrast_waymo5_dethead_1w_$(date +%Y-%m-%d_%H:%M).out 2>&1
scripts/submit_ddp_turing.sh --num_gpus 2 --cuda_visible_devices 2,3 --tcp_port 19836 --cfg_file configs/waymo_minkunet_segcontrast_waymo5_dethead_1w.yaml --pretrain_batchsize_per_gpu 16 --finetune_batchsize_per_gpu 8 --model_name minkunet_pretrain_segcontrast_waymo5_dethead_1w_try2 --pretrained_ckpt checkpoint-ep49.pth.tar > ./output/log/minkunet_pretrain_segcontrast_waymo5_dethead_1w_try2_$(date +%Y-%m-%d_%H:%M).out 2>&1
